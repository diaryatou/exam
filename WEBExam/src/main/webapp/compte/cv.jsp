      ...
      <div id="header">
        ...
        <div class="header_menu_container">
          <ul class="download_print_buttons horizontal_list">
            <li><a href="cv?print=ok"><span class="icon entypo-download"></span>Download CV</a></li>
            <li><a href="cv?print=ok"><span class="icon entypo-print"></span>Print CV</a></li>
          </ul>
          <div class="clear"></div>
